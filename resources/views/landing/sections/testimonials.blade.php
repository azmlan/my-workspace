<section id="testimonials" class="py-20 lg:py-32 bg-gray-950">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12 lg:mb-16">
            ...
            <p class="reveal text-gray-400 text-lg max-w-2xl mx-auto" style="transition-delay: 0.1s;">
                تجارب من سعدت بالعمل معهم
            </p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            @foreach($testimonials as $index => $testimonial)
                <div class="reveal bg-gray-900 rounded-xl p-6 lg:p-8 border border-gray-800" style="transition-delay: {{ ($index % 3) * 0.1 }}s;">
